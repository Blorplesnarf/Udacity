...
class Task():
    ...
    def __init__(self, init_pose=None, init_velocities=None, 
        ...
        self.action_repeat = 3 # Taken from paper - changed from 3 originally
    ...
    def get_reward(self):
        ...
        reward = 1-2*np.tanh(0.1*np.linalg.norm(self.sim.pose[2] - self.target_pos[2])) -  # negative tanh of the euler distance. Reward [-1 to 0]
